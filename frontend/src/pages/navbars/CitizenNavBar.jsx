...
const tabs = [
  { name: "Home", href: "/citizenhome" },
  { name: "Add Case", href: "/addcasecitizen" },
  { name: "My Cases", href: "/mycasescitizen" },
...
const CitizenNavBar = () => {
  ...
  return (
    <div className="px-4 py-0.1 bg-black flex items-center flex-wrap gap-2">
      {/* Navigation tabs */}
